...
public abstract class TypeEdgeImpl implements TypeEdge {
        ...
        public void commit() {
            if (committed.compareAndSet(false, true)) {
                if (encoding.out() != null) {
                    if (overridden != null) graph.storage().put(outIID().byteArray(), overridden.iid().byteArray());
                    else graph.storage().put(outIID().byteArray());
                }
                if (encoding.in() != null) {
    ...
    public static class Persisted extends TypeEdgeImpl implements TypeEdge {
        ...
        public void overridden(TypeVertex overridden) {
            ...
            graph.storage().put(outIID.byteArray(), overriddenIID.byteArray());
        }
